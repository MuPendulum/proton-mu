...
$(2)_$(3)_ENV = \
    ...
    CFLAGS="$$($(2)_$(3)_INCFLAGS) $$(CFLAGS) $$($(2)_CFLAGS) $$($(3)_CFLAGS) $$($(2)_$(3)_CFLAGS)" \
    CPPFLAGS="$$($(2)_$(3)_INCFLAGS) $$(CFLAGS) $$($(2)_CFLAGS) $$($(3)_CFLAGS) $$($(2)_$(3)_CFLAGS)" \
    CXXFLAGS="$$($(2)_$(3)_INCFLAGS) -std=c++17 $$(CFLAGS) $$($(2)_CFLAGS) $$($(3)_CFLAGS) $$($(2)_$(3)_CFLAGS)" \
...
$(2)_$(3)_ENV += \
    CROSSCFLAGS="$$($(2)_$(3)_INCFLAGS) $$(CFLAGS) $$($(2)_CFLAGS) $$($(3)_CFLAGS) $$($(2)_$(3)_CFLAGS)" \
