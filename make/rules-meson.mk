...
c_args = [$$(call list-quote,$$($(2)_$(3)_INCFLAGS) $$(CFLAGS) $$($(2)_CFLAGS) $$($(3)_CFLAGS) $$($(2)_$(3)_CFLAGS))]
cpp_args = [$$(call list-quote,$$($(2)_$(3)_INCFLAGS) $$(CFLAGS) $$($(2)_CFLAGS) $$($(3)_CFLAGS) $$($(2)_$(3)_CFLAGS))]
